...
user_MODULES := $(sort \
        $(call get-tagged-modules,user) \
        $(call module-installed-files, $(PRODUCTS.$(INTERNAL_PRODUCT).PRODUCT_PACKAGES_USER)) \
)
...
.PHONY: wifi
wifi:
	if [ -e ./external/wpa_supplicant_8_mtk6620/wpa_supplicant/Android.mk ] ; then make ONE_SHOT_MAKEFILE=./external/wpa_supplicant_8_mtk6620/wpa_supplicant/Android.mk; fi
	if [ -e ./hardware/libhardware_legacy/mtk6620_Android.mk ] ; then make ONE_SHOT_MAKEFILE=./hardware/libhardware_legacy/mtk6620_Android.mk; fi
	if [ -e ./system/netd/mtk6620_Android.mk ] ; then make ONE_SHOT_MAKEFILE=./system/netd/mtk6620_Android.mk; fi
	find ./external/bluetooth/bluedroid | xargs touch
	if [ -e ./external/bluetooth/bluedroid/stack/mtk6620_Android.mk ] ; then make ONE_SHOT_MAKEFILE=./external/bluetooth/bluedroid/stack/mtk6620_Android.mk; fi
	if [ -e ./external/bluetooth/bluedroid/main/mtk6620_Android.mk ] ; then make ONE_SHOT_MAKEFILE=./external/bluetooth/bluedroid/main/mtk6620_Android.mk; fi
	if [ -e ./external/wpa_supplicant_8_rtl8192e/wpa_supplicant/Android.mk ] ; then make ONE_SHOT_MAKEFILE=./external/wpa_supplicant_8_rtl8192e/wpa_supplicant/Android.mk; fi
	if [ -e ./external/wpa_supplicant_8_rtl8192e/hostapd/Android.mk ] ; then make ONE_SHOT_MAKEFILE=./external/wpa_supplicant_8_rtl8192e/hostapd/Android.mk; fi
	if [ -e ./external/wpa_supplicant_8_rtl8192c/wpa_supplicant_8192c/Android.mk ] ; then make ONE_SHOT_MAKEFILE=./external/wpa_supplicant_8_rtl8192c/wpa_supplicant_8192c/Android.mk; fi
	if [ -e ./external/wpa_supplicant_8_rtl8192c/hostapd_rtl8192c/Android.mk ] ; then make ONE_SHOT_MAKEFILE=./external/wpa_supplicant_8_rtl8192c/hostapd_rtl8192c/Android.mk; fi
	if [ -e ./hardware/libhardware_legacy/Android.mk ] ; then make ONE_SHOT_MAKEFILE=./hardware/libhardware_legacy/Android.mk; fi
	if [ -e ./external/wpa_supplicant_8_mtk7601/wpa_supplicant/Android.mk ] ; then make ONE_SHOT_MAKEFILE=./external/wpa_supplicant_8_mtk7601/wpa_supplicant/Android.mk; fi
	if [ -e ./external/wpa_supplicant_8_mtk7601/hostapd/Android.mk ] ; then make ONE_SHOT_MAKEFILE=./external/wpa_supplicant_8_mtk7601/hostapd/Android.mk; fi
	if [ -e ./external/wpa_supplicant_8_mtk5931/wpa_supplicant/Android.mk ] ; then make ONE_SHOT_MAKEFILE=./external/wpa_supplicant_8_mtk5931/wpa_supplicant/Android.mk; fi
	if [ -e ./hardware/libhardware_legacy/mt5931_Android.mk ] ; then make ONE_SHOT_MAKEFILE=./hardware/libhardware_legacy/mt5931_Android.mk; fi
	if [ -e ./system/netd/mt5931_Android.mk ] ; then make ONE_SHOT_MAKEFILE=./system/netd/mt5931_Android.mk; fi
	if [ -e ./system/netd/eagle_Android.mk ] ; then make ONE_SHOT_MAKEFILE=./system/netd/eagle_Android.mk; fi
	if [ -e ./external/wpa_supplicant_8_nmi1000/wpa_supplicant/Android.mk ] ; then make ONE_SHOT_MAKEFILE=./external/wpa_supplicant_8_nmi1000/wpa_supplicant/Android.mk; fi
	if [ -e ./hardware/libhardware_legacy/nmc1000_Android.mk ] ; then make ONE_SHOT_MAKEFILE=./hardware/libhardware_legacy/nmc1000_Android.mk; fi
	if [ -e ./hardware/broadcom/wlan/bcmdhd/wpa_supplicant_8_lib/Android.mk ] ; then make ONE_SHOT_MAKEFILE=./hardware/broadcom/wlan/bcmdhd/wpa_supplicant_8_lib/Android.mk; fi
	if [ -e ./external/wpa_supplicant_8_bcm/wpa_supplicant/Android.mk ] ; then make ONE_SHOT_MAKEFILE=./external/wpa_supplicant_8_bcm/wpa_supplicant/Android.mk; fi
	if [ -e ./external/wpa_supplicant_8_bcm/hostapd/Android.mk ] ; then make ONE_SHOT_MAKEFILE=./external/wpa_supplicant_8_bcm/hostapd/Android.mk; fi
	if [ -e ./hardware/eagle/wlan/wpa_supplicant_8_lib/Android.mk ] ; then make ONE_SHOT_MAKEFILE=./hardware/eagle/wlan/wpa_supplicant_8_lib/Android.mk; fi
	if [ -e ./external/wpa_supplicant_8_eagle/wpa_supplicant/Android.mk ] ; then make ONE_SHOT_MAKEFILE=./external/wpa_supplicant_8_eagle/wpa_supplicant/Android.mk; fi
	if [ -e ./external/wpa_supplicant_8_eagle/hostapd/Android.mk ] ; then make ONE_SHOT_MAKEFILE=./external/wpa_supplicant_8_eagle/hostapd/Android.mk; fi
.PHONY: docs
docs: $(ALL_DOCS)
